...
class CreateFactoryClassWithRelationsTest extends TestCase
{
    /**
    ...
    /** @test */
    public function canAddRelationToSameBaseFactoryWithoutSideEffects()
    {
        /** @var FactoryClass $hasOneFactory */
        $hasOneFactory = $this->getHasOneFactory()::new();
        ...
        $hasOneModel = $hasOneFactory->hasMany('hasManyRelation', [$belongsToFactory])->create();
        $hasOneSecondModel = $hasOneFactory->hasMany('hasManyRelation', [$belongsToFactory, $secondBelongsToFactory])->create();
    ...
    public function canCreateAModelWithAGivenBelongsToManyRelation()
    {
        ...
        $this->assertCount(2, HasOneModel::all());
        $this->assertCount(1, BelongsToModel::all());
